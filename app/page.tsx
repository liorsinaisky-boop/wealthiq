...
const CATEGORIES = [
  ...
  { name: "צמיחת עושר",      weight: 20, color: "var(--tangerine)", score: 74 },
    ...
    <div style={{ backgroundColor: "var(--bg)", color: "var(--text-primary)", minHeight: "100vh" }}>
      ...
      >
        <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-6">
          <span className="font-sora text-lg font-bold" style={{ color: "var(--text-primary)" }}>
            WealthIQ
          </span>
          <div className="hidden items-center gap-8 text-sm md:flex" style={{ color: "var(--text-muted)" }}>
            <a href="#how"      className="transition-colors hover:text-slate-900">איך זה עובד</a>
            <a href="#score"    className="transition-colors hover:text-slate-900">מנוע הניקוד</a>
            <a href="#features" className="transition-colors hover:text-slate-900">יכולות</a>
          </div>
          <Link href="/check" className="btn-tangerine px-5 py-2 text-sm">
            התחל בדיקה ←
          </Link>
        </div>
      </nav>
        ...
        <div className="mx-auto grid max-w-6xl items-center gap-16 md:grid-cols-2">
          ...
          >
            ...
            <h1
              ...
              style={{ fontSize: "clamp(34px, 4.5vw, 54px)", letterSpacing: "-2px", color: "var(--text-primary)" }}
            >
              ניהול פיננסי <span className="tangerine-text font-serif italic animate-pulse">חכם</span> <br />
              עבור העתיד שלך.
            </h1>
            <p className="mb-10 leading-relaxed" style={{ fontSize: "17px", color: "var(--text-muted)" }}>
              פנסיה, נדל״ן, השקעות, חסכונות וחובות — הכל במקום אחד.
              ענה/י על כמה שאלות וקבל/י ציון מ-0 עד 100 עם תובנות מותאמות אישית.
            </p>
            <Link
              href="/check"
              className="btn-tangerine w-full md:w-auto justify-center md:inline-flex items-center gap-2 px-8 py-4 text-base shadow-sm hover:shadow-xl"
            >
              התחל בדיקה חינמית ←
            </Link>
            ...
            <div className="mt-12 flex gap-10">
              <div>
                <AnimatedNumber value={45} duration={1200} className="font-jetbrains-mono text-2xl font-bold" style={{ color: "var(--tangerine)" }} />
                <div className="mt-0.5 text-sm" style={{ color: "var(--text-muted)" }}>שאלות</div>
              </div>
              <div>
                <AnimatedNumber value={6} duration={800} className="font-jetbrains-mono text-2xl font-bold" style={{ color: "var(--tangerine)" }} />
                <div className="mt-0.5 text-sm" style={{ color: "var(--text-muted)" }}>ממדים</div>
              </div>
              <div>
                <div className="font-jetbrains-mono text-2xl font-bold" style={{ color: "var(--tangerine)" }}>0</div>
                <div className="mt-0.5 text-sm" style={{ color: "var(--text-muted)" }}>נתונים נשמרים</div>
              </div>
            </div>
          </motion.div>
            ...
            <div className="relative" style={{ width: "340px", height: "340px" }}>
              ...
              >
                <svg width={RING} height={RING} style={{ transform: "rotate(-90deg)" }}>
                  ...
                  <motion.circle
                    ...
                    style={{
                      filter: "drop-shadow(0 0 12px var(--tangerine)) drop-shadow(0 0 28px var(--tangerine-glow))",
                    }}
                  />
                </svg>
                {/* Center text */}
                ...
                >
                  <motion.span
                    ...
                    style={{ fontSize: "72px", lineHeight: 1, color: "var(--text-primary)", letterSpacing: "-3px" }}
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
              ...
              {PILLS.map((pill, i) => (
                <motion.div
                  ...
                  className="absolute hidden text-xs md:flex items-center px-3 py-1.5 rounded-full shadow-sm"
                  style={{
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid gap-5 md:grid-cols-3">
            {HOW_IT_WORKS.map((step, i) => (
              ...
              <div
                key={step.num}
                className="card relative p-8 transition-colors duration-300 hover:border-slate-300 hover:shadow-md bg-white border border-slate-100"
              >
                {/* Ghost number */}
                <span
                ...
                <p className="leading-relaxed" style={{ fontSize: "15px", color: "var(--text-muted)" }}>
                  {step.desc}
                </p>
              </div>
              </ScrollReveal>
      ...
      <section
        id="score"
        className="px-6 py-24 bg-slate-50"
      ...
      >
        <div className="mx-auto grid max-w-6xl items-start gap-16 md:grid-cols-2">
          ...
          <div>
            ...
            <p className="mb-10 leading-relaxed" style={{ fontSize: "15px", color: "var(--text-muted)" }}>
          ...
          <div
            className="card p-8 bg-white border border-slate-200 shadow-sm"
          >
            <div className="mb-6 flex items-center justify-between">
              <div>
                <p className="mb-1 text-sm" style={{ color: "var(--text-muted)" }}>ציון לדוגמה</p>
                <span
                  className="font-sora font-bold"
                  style={{ fontSize: "52px", color: "var(--text-primary)", letterSpacing: "-2px", lineHeight: 1 }}
                >
                  72
                </span>
              </div>
              ...
              <svg width={80} height={80} style={{ transform: "rotate(-90deg)" }}>
                <circle cx={40} cy={40} r={32} fill="none" stroke="rgba(15,23,42,0.06)" strokeWidth={6} />
                <circle
                  cx={40} cy={40} r={32}
                  fill="none"
                  stroke="var(--tangerine)"
                  ...
                  style={{ filter: "drop-shadow(0 0 6px var(--tangerine-glow))" }}
                />
              </svg>
            </div>
            <div className="space-y-4">
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            {FEATURES.map((feat, i) => (
              ...
              <div
                key={feat.num}
                className="card p-7 bg-white transition-all duration-300 hover:border-slate-300 hover:shadow-lg hover:bg-slate-50 border border-slate-100"
              >
                ...
                <p className="leading-relaxed" style={{ fontSize: "14px", color: "var(--text-muted)" }}>
                  {feat.desc}
                </p>
              </div>
              </ScrollReveal>
      ...
      {/* ── CTA ─────────────────────────────────────────────── */}
      <section className="relative overflow-hidden px-6 py-28 text-center bg-slate-50 border-t border-slate-100">
        {/* Radial glow */}
        <div
        ...
        <div className="relative">
          ...
          <p className="mb-10 text-[15px]" style={{ color: "var(--text-muted)" }}>
            חינם לחלוטין &bull; כ-10 דקות &bull; ללא הרשמה
          </p>
          <Link
            href="/check"
            className="btn-tangerine inline-flex items-center gap-2 px-10 py-4 text-base"
            style={{ boxShadow: "0 0 48px var(--tangerine-glow)" }}
          >
            התחל עכשיו ←
          </Link>
        </div>
      ...
      >
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 md:flex-row">
          <span className="font-sora font-semibold" style={{ color: "var(--text-primary)" }}>WealthIQ</span>
          ...
          <p className="text-xs" style={{ color: "var(--text-muted)" }}>נבנה על ידי Lior</p>
        </div>
      </footer>
    </div>
  );
