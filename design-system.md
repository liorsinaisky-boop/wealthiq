# Design System: Fintech Pro

> **Query**: "Fintech Pro dashboard for personal wealth assessment, dark theme, gold accents, RTL Hebrew" | **Tech Stack**: nextjs | **Generated**: 3/19/2026

## 01. Foundation
- **Primary Color**: `#0A1929` ![#0A1929](https://via.placeholder.com/15/0A1929/000000?text=+)
- **Typography**: **Noto Sans Hebrew** (Headings & Body)

### Color Palette
#### Primary Brand
| Stop | Hex | Preview |
| :--- | :--- | :--- |
| **50** | `#EAF2FB` | ![#EAF2FB](https://via.placeholder.com/80x30/EAF2FB/EAF2FB?text=+) |
| **100** | `#D5E5F6` | ![#D5E5F6](https://via.placeholder.com/80x30/D5E5F6/D5E5F6?text=+) |
| **200** | `#ADCBEB` | ![#ADCBEB](https://via.placeholder.com/80x30/ADCBEB/ADCBEB?text=+) |
| **300** | `#84B1E1` | ![#84B1E1](https://via.placeholder.com/80x30/84B1E1/84B1E1?text=+) |
| **400** | `#5B97D7` | ![#5B97D7](https://via.placeholder.com/80x30/5B97D7/5B97D7?text=+) |
| **500** | `#327DCD` | ![#327DCD](https://via.placeholder.com/80x30/327DCD/327DCD?text=+) |
| **600** | `#2864A4` | ![#2864A4](https://via.placeholder.com/80x30/2864A4/2864A4?text=+) |
| **700** | `#1E4B7B` | ![#1E4B7B](https://via.placeholder.com/80x30/1E4B7B/1E4B7B?text=+) |
| **800** | `#143252` | ![#143252](https://via.placeholder.com/80x30/143252/143252?text=+) |
| **900** | `#09192A` | ![#09192A](https://via.placeholder.com/80x30/09192A/09192A?text=+) |
| **950** | `#040C15` | ![#040C15](https://via.placeholder.com/80x30/040C15/040C15?text=+) |

#### Neutral
| Stop | Hex | Preview |
| :--- | :--- | :--- |
| **50** | `#ECF2F9` | ![#ECF2F9](https://via.placeholder.com/80x30/ECF2F9/ECF2F9?text=+) |
| **100** | `#D8E5F3` | ![#D8E5F3](https://via.placeholder.com/80x30/D8E5F3/D8E5F3?text=+) |
| **200** | `#B5CBE3` | ![#B5CBE3](https://via.placeholder.com/80x30/B5CBE3/B5CBE3?text=+) |
| **300** | `#8FB1D6` | ![#8FB1D6](https://via.placeholder.com/80x30/8FB1D6/8FB1D6?text=+) |
| **400** | `#6A97C8` | ![#6A97C8](https://via.placeholder.com/80x30/6A97C8/6A97C8?text=+) |
| **500** | `#457EBA` | ![#457EBA](https://via.placeholder.com/80x30/457EBA/457EBA?text=+) |
| **600** | `#376495` | ![#376495](https://via.placeholder.com/80x30/376495/376495?text=+) |
| **700** | `#294B70` | ![#294B70](https://via.placeholder.com/80x30/294B70/294B70?text=+) |
| **800** | `#1C324A` | ![#1C324A](https://via.placeholder.com/80x30/1C324A/1C324A?text=+) |
| **900** | `#0C1927` | ![#0C1927](https://via.placeholder.com/80x30/0C1927/0C1927?text=+) |
| **950** | `#060D13` | ![#060D13](https://via.placeholder.com/80x30/060D13/060D13?text=+) |
