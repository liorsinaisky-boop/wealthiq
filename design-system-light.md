# Design System: Card-Based

> **Query**: "Light theme financial setup, elegant, clean white background, deep blue/black typography. Mix geometric sans-serif with elegant italic serif fonts for headings. Use a vibrant orange/tangerine for accents and primary buttons. Soft light drop shadows for cards" | **Tech Stack**: nextjs | **Generated**: 3/19/2026

## 01. Foundation
- **Primary Color**: `#FFFFFF` ![#FFFFFF](https://via.placeholder.com/15/FFFFFF/000000?text=+)
- **Typography**: **Syne** (Headings & Body)

### Color Palette
#### Primary Brand
| Stop | Hex | Preview |
| :--- | :--- | :--- |
| **50** | `#F3F2F2` | ![#F3F2F2](https://via.placeholder.com/80x30/F3F2F2/F3F2F2?text=+) |
| **100** | `#E7E4E4` | ![#E7E4E4](https://via.placeholder.com/80x30/E7E4E4/E7E4E4?text=+) |
| **200** | `#CCCCCC` | ![#CCCCCC](https://via.placeholder.com/80x30/CCCCCC/CCCCCC?text=+) |
| **300** | `#B3B3B3` | ![#B3B3B3](https://via.placeholder.com/80x30/B3B3B3/B3B3B3?text=+) |
| **400** | `#999999` | ![#999999](https://via.placeholder.com/80x30/999999/999999?text=+) |
| **500** | `#808080` | ![#808080](https://via.placeholder.com/80x30/808080/808080?text=+) |
| **600** | `#666666` | ![#666666](https://via.placeholder.com/80x30/666666/666666?text=+) |
| **700** | `#4D4D4D` | ![#4D4D4D](https://via.placeholder.com/80x30/4D4D4D/4D4D4D?text=+) |
| **800** | `#333333` | ![#333333](https://via.placeholder.com/80x30/333333/333333?text=+) |
| **900** | `#1B1818` | ![#1B1818](https://via.placeholder.com/80x30/1B1818/1B1818?text=+) |
| **950** | `#0D0C0C` | ![#0D0C0C](https://via.placeholder.com/80x30/0D0C0C/0D0C0C?text=+) |

#### Neutral
| Stop | Hex | Preview |
| :--- | :--- | :--- |
| **50** | `#F2F2F2` | ![#F2F2F2](https://via.placeholder.com/80x30/F2F2F2/F2F2F2?text=+) |
| **100** | `#E6E6E6` | ![#E6E6E6](https://via.placeholder.com/80x30/E6E6E6/E6E6E6?text=+) |
| **200** | `#CCCCCC` | ![#CCCCCC](https://via.placeholder.com/80x30/CCCCCC/CCCCCC?text=+) |
| **300** | `#B3B3B3` | ![#B3B3B3](https://via.placeholder.com/80x30/B3B3B3/B3B3B3?text=+) |
| **400** | `#999999` | ![#999999](https://via.placeholder.com/80x30/999999/999999?text=+) |
| **500** | `#808080` | ![#808080](https://via.placeholder.com/80x30/808080/808080?text=+) |
...
| **700** | `#4D4D4D` | ![#4D4D4D](https://via.placeholder.com/80x30/4D4D4D/4D4D4D?text=+) |
| **800** | `#333333` | ![#333333](https://via.placeholder.com/80x30/333333/333333?text=+) |
| **900** | `#1A1A1A` | ![#1A1A1A](https://via.placeholder.com/80x30/1A1A1A/1A1A1A?text=+) |
| **950** | `#0D0D0D` | ![#0D0D0D](https://via.placeholder.com/80x30/0D0D0D/0D0D0D?text=+) |
